```Algebra.md``` contém uma série de comandos que podem ser executados em máxima, eles são o passo a passo do desenvolvimento algébrico da técnica de Freudenstein. 
